...
class DepartamentoSearch extends Departamento
{
    ...
    public function rules()
    {
        return [
            ...
            [['nomDepartamento', 'siglaDepartamento', 'descripcion', 'centroCosto'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'nomDepartamento', $this->nomDepartamento])
            ->andFilterWhere(['like', 'siglaDepartamento', $this->siglaDepartamento])
